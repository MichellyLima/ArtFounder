...
public class TelaAlterar extends JFrame{
	...
	public TelaAlterar(ObradeArte obradeArte){
		initialize(obradeArte);
	...
	private void initialize(ObradeArte obradeArte){
		...
		JLabel lblCadastrarObraDe = new JLabel("ALTERAR OBRA DE ARTE");
		...
		nomeObra.setText(obradeArte.getNome());
		...
		localizacaoObra.setText(obradeArte.getLocalizacao());
		...
		nomeAutor.setText(obradeArte.getAutor().getNome());;
		...
		nacionalidadeAutor.setText(obradeArte.getAutor().getNacionalidade());
